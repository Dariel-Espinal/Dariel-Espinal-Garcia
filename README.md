...
- 🔐 Construyendo **USB Security Scanner** — toolkit portátil de ciberseguridad en PowerShell
- 🏋️ Desarrollando proyectos en Python, comenzando con una **Calculadora de IMC**
- 🌱 Aprendiendo actualmente: **SQL Server · ASP.NET Core MVC · Ciberseguridad**
- 💬 Pregúntame sobre: `Python` · `PowerShell` · `SQL Server` · `Ciberseguridad`
